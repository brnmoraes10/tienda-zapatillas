...
import { getItems, createItem, deleteItem } from '../../api/api'; // Asegúrate que la ruta a tu API sea correcta
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div style={styles.formGroup}>
            ...
            <input
              ...
              {...register('email', { required: 'El email es obligatorio', pattern: { value: /^\S+@\S+$/i, message: 'Formato de email inválido' } })}
            />
